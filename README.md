...
欢迎百度aistudio中fork项目并运行。https://aistudio.baidu.com/aistudio/projectdetail/1170556?shared=1

参加了aistudio的分割课程之后【课程链接[ https://aistudio.baidu.com/aistudio/course/introduce/1767 ]，试效果，就使用了PaddleSeg开发套件进行自己的项目。
